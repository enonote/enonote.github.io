...
(function($){
	$.fn.extend({ 
		...
		var randID =  Math.round(Math.random()*100000000);
			...
			if( o.leftMsg != "" || o.rightMsg != "" )
			{
				$(obj).append('<span style="" id="lt-overlay" class="overlay">'+o.leftMsg+'</span><span style="" id="rt-overlay" class="overlay">'+o.rightMsg+'</span>');
			}
			$('#lt-overlay').css({'left':parseInt($('#dragwrapper'+randID).css('left'))-$('#lt-overlay').width() -50 +'px'});
			$('#rt-overlay').css({'left':parseInt($('#dragwrapper'+randID).css('left'))+30+'px'});
			if(o.showFullLinks)
			{	
			...
			function clickit()
			{
				...
				$(obj).click(function(e){
					...
					$('#lt-overlay').stop().animate({'left': clickX - ($('#dragwrapper'+randID).width()/2) - $('#lt-overlay').width() -50 +'px'},o.clickSpeed);
					$('#rt-overlay').stop().animate({'left': clickX +30 +'px'},o.clickSpeed);
